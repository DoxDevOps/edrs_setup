      ...
      parallel {
        stage('Remote Server Configuration') {
          steps {
            ...
            sh '''#OpsUser
ssh opsuser@10.44.0.52 "sed -i \'s/facility_code\\:/facility_code\\: 3333/; s/district_code\\:/district_code\\: DV3/; s/site_type\\: dc/site_type\\: facility/\' /home/opsuser/edrs_facility/config/settings.yml"

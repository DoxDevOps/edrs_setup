      ...
      parallel {
        ...
        stage('Copying .example files to .yml files') {
          steps {
            ...
            sh 'sed -i \'s/\\/home\\/usr\\/barcodes\\//\\/var\\/www\\/edrs_facility\\/config\\//; s/\\/home\\/usr\\/certificates\\//\\/var\\/www\\/edrs_facility\\/config\\//; s/\\/home\\/usr\\/dispatch\\//\\/var\\/www\\/edrs_facility\\/config\\//; s/\\/home\\/usr\\/qrcodes\\//\\/var\\/www\\/edrs_facility\\/config\\//; s/site_type\\:\\s dc/site_type\\: facility #/\' $WORKSPACE/edrs_facility/config/settings.yml'
            ...
            sh 'sed -i \'s/site_type\\: dc/site_type\\: facility/\' $WORKSPACE/edrs_facility/config/settings.yml'
          }
        }
